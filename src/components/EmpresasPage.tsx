      ...
      <main className="flex-1">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-end">
              <div className="lg:col-span-7 space-y-6">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-light tracking-[-0.04em] leading-[1.05]">
              ...
              <div className="lg:col-span-5 grid grid-cols-2 border border-[#0A0A0A]/10">
                {[
                  ...
                  >
                    <div className="font-display text-3xl sm:text-4xl tracking-wide font-medium">{stat.value}</div>
                    <div className="kicker mt-2 !text-[11px]">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-6 relative">
              <div className="aspect-[4/5] sm:aspect-[5/4] overflow-hidden bg-[#EDEDEC]">
                <img
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-[#0A0A0A] text-[#F7F7F5] px-5 py-3 flex items-center justify-between">
                <span className="font-display text-[13px] tracking-[0.16em] uppercase">Finger food ejecutivo</span>
                <span className="text-[11px] text-white/50">Maceiras · Santiago</span>
              </div>
            </div>
        ...
        <section id="formatos" className="py-16 sm:py-24 border-t border-[#0A0A0A]/8">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="max-w-2xl mb-12 sm:mb-16 space-y-3">
              ...
              <h2 className="text-3xl sm:text-4xl font-light tracking-[-0.03em]">
            ...
            <div className="border-t border-[#0A0A0A]/10">
              {CORPORATE_FORMATS.map((format, index) => (
                ...
                >
                  <div className="md:col-span-2 font-display text-2xl text-[#0A0A0A]/30 group-hover:text-[#0A0A0A] transition-colors">
                    {format.number}
                  </div>
        ...
        <section className="py-16 sm:py-24 bg-white border-y border-[#0A0A0A]/8">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#0A0A0A]/8 border border-[#0A0A0A]/8">
              {CORPORATE_CAPABILITIES.map((item, i) => {
                const icons = [Clock, Shield, Building2, FileText];
                const Icon = icons[i] ?? Check;
                return (
                  <div key={item.title} className="bg-[#F7F7F5] p-8 sm:p-10 space-y-4">
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl font-light tracking-[-0.03em]">Santiago y el sector oriente.</h2>
            ...
            <div className="grid grid-cols-2 gap-px bg-[#0A0A0A]/8 border border-[#0A0A0A]/8 h-fit">
              {['Vitacura', 'Las Condes', 'Lo Barnechea', 'Providencia', 'La Dehesa', 'Chicureo'].map((comuna) => (
                <div key={comuna} className="bg-[#F7F7F5] px-5 py-4 text-sm tracking-tight">
                  {comuna}
                </div>
              ))}
            </div>
        ...
        <section className="bg-[#0A0A0A] text-[#F7F7F5] py-20 sm:py-24">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            <div className="max-w-xl space-y-4">
              <span className="font-display text-[12px] tracking-[0.22em] uppercase text-white/45">Siguiente paso</span>
              <h2 className="text-3xl sm:text-4xl font-light tracking-[-0.03em] leading-tight">
            ...
            <button
              onClick={() => onOpenQuote('Eventos Corporativos & Ejecutivos')}
              className="inline-flex items-center gap-2 px-7 py-4 bg-[#F7F7F5] text-[#0A0A0A] font-display text-[13px] font-semibold tracking-[0.16em] uppercase hover:bg-white transition-colors cursor-pointer"
            >
