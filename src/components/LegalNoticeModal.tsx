      ...
      >
        ...
        <div className="bg-[#2A2A2A] text-[#F5F2ED] px-6 py-4 flex items-center justify-between border-b border-[#F5F2ED]/10 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#5A5A40] text-[#F5F2ED] flex items-center justify-center">
              <Scale className="w-4 h-4 text-[#D27D56]" />
            </div>
            <div>
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-xs text-[#2A2A2A]/80 font-sans leading-relaxed">
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">1. Datos Identificativos</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">2. Propiedad Intelectual</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">3. Condiciones del Servicio</h3>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">4. Contacto Oficial</h3>
            <p>
              Para consultas legales, comerciales o dudas sobre nuestras propuestas gastronómicas, puede comunicarse directamente a nuestro correo <a href="mailto:maceiras.shop@gmail.com" className="text-[#D27D56] underline font-medium">maceiras.shop@gmail.com</a> o teléfono <span className="font-mono text-[#D27D56]">+56 9 3193 9017</span>.
            </p>
          </div>
        </div>
