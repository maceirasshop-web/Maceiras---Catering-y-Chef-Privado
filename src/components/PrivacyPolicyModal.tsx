...
export const PrivacyPolicyModal: React.FC<PrivacyPolicyModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-[#2A2A2A]/70 backdrop-blur-xs font-sans">
      <motion.div
        initial={{ opacity: 0, scale: 0.96, y: 15 }}
        animate={{ opacity: 1, scale: 1, y: 0 }}
        exit={{ opacity: 0, scale: 0.96, y: 15 }}
        transition={{ duration: 0.25 }}
        className="bg-[#F5F2ED] rounded-xs max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl border border-[#2A2A2A]/20 overflow-hidden relative"
      >
        {/* Header */}
        <div className="bg-[#2A2A2A] text-[#F5F2ED] px-6 py-4 flex items-center justify-between border-b border-[#F5F2ED]/10 shrink-0">
        ...
        {/* Body Content */}
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-xs text-[#2A2A2A]/80 font-sans leading-relaxed">
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">1. Compromiso de Privacidad</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">2. Recopilación de Datos</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">3. Uso y Confidencialidad</h3>
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-xl text-[#2A2A2A] font-light">4. Sus Derechos</h3>
            <p>
              En cualquier momento, usted tiene derecho a solicitar la eliminación, rectificación o actualización de sus datos de nuestra base enviando un mensaje al correo <a href="mailto:maceiras.shop@gmail.com" className="text-[#D27D56] underline font-medium">maceiras.shop@gmail.com</a>.
            </p>
          </div>
        </div>

        {/* Footer Action */}
        <div className="p-4 bg-[#EADDCA]/30 border-t border-[#2A2A2A]/10 flex justify-end shrink-0">
          <button
            onClick={onClose}
